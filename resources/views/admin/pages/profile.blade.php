                    ...
                    <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="business_name" value="{{ old('business_name', $user->business_name) }}" class="w-full border-gray-200 rounded-xl p-3 text-sm focus:ring-2 focus:ring-indigo-400 outline-none border transition-all">
                            </div>

                            <div class="space-y-2">
                                <label class="text-sm font-semibold text-gray-600">Your Name</label>
                                <input type="text" name="name" value="{{ old('name', $user->name) }}" class="w-full border-gray-200 rounded-xl p-3 text-sm focus:ring-2 focus:ring-indigo-400 outline-none border transition-all">
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="contact_no" value="{{ old('contact_no', $user->contact_no) }}" class="w-full border-gray-200 rounded-xl p-3 text-sm focus:ring-2 focus:ring-indigo-400 outline-none border transition-all">
                            </div>

                            <div class="space-y-2">
                                <label class="text-sm font-semibold text-gray-600">About Business/You</label>
                                <input type="text" name="about" value="{{ old('about', $user->about) }}" placeholder="Enter About Details" class="w-full border-gray-200 rounded-xl p-3 text-sm focus:ring-2 focus:ring-indigo-400 outline-none border transition-all">
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="city" value="{{ old('city', $user->city) }}" placeholder="Enter City" class="w-full border-gray-200 rounded-xl p-3 text-sm focus:ring-2 focus:ring-indigo-400 outline-none border transition-all">
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="zip_code" value="{{ old('zip_code', $user->zip_code) }}" placeholder="Enter Zip Code" class="w-full border-gray-200 rounded-xl p-3 text-sm focus:ring-2 focus:ring-indigo-400 outline-none border transition-all">
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div id="logoPreviewBox" class="w-32 h-32 bg-gray-100 border border-dashed border-gray-300 rounded-xl flex items-center justify-center overflow-hidden">
                                        @if($user->logo)
                                            <img src="{{ asset('storage/' . $user->logo) }}" class="w-full h-full object-cover">
                                        @else
                                            <span class="placeholder text-[10px] text-gray-400 text-center p-2">No logo uploaded</span>
                        ...
                        <div class="pt-4 text-right">
                            <button type="submit" class="bg-blue-600 text-white px-8 py-3 rounded-xl text-sm font-bold shadow-md hover:bg-blue-700 transition">Update Profile</button>
                        </div>
                    </form>
                </div>
            </div>
